  ...
  <section className={styles.container}>
    ...
    <div className={styles.category}>
      ...
      <div className={styles.tags}>
        ...
        <label className={styles.hashtag}><input type="checkbox" name="tag3" value="3"/>#뷰티</label>
        ...
        <label className={styles.hashtag}><input type="checkbox" name="tag6" value="6"/>#디지털</label>
      </div>
    </div>
