    ...
    <section className={styles.container}>
      ...
      <div className={styles.options}>
        <label className={styles.optionName}>
          <input className={styles.radioBox} type="radio" onClick={handleVote}/>{feed.option_1}
        </label>
        <label className={styles.optionName}>
          <input className={styles.radioBox} type="radio" onClick={handleVote}/>{feed.option_2}
        </label>
      </div>
    </section>
  )
